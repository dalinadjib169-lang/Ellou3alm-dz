...
// fix the error handling message to show the real error
studentView = studentView.replace(
...
// there are two places in GraphView
graphView = graphView.replaceAll(
  "setError('فشل في الاتصال بالخادم');",
  "setError(errData.error || 'فشل في الاتصال بالخادم');"
);
