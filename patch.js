...
code = code.replace(
  ...
  `{isDark ? <Sun size={20} /> : <Moon size={20} />}
          ...
          <button
            ...
            className="px-3 py-1 rounded-full bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-300 dark:hover:bg-slate-700 transition-colors font-bold text-sm"
            title="تغيير اللغة"
          >
            {language}
          </button>`
